        ...
        <div class=" mt-5 row d-flex justify-content-center align-items-center shadow"
            ...
            <div class="col p-3 bg-img mt-5 ">
                <div class="bg-app p-5">
                    ...
                    <form @submit.prevent="enviarFormulario" class="mt-5" enctype="multipart/form-data"
                        v-if="images == false">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input v-model="usuario.telefono" type="text" class="borderless-input mt-3" required>
                        </div>
                        <div class="text-right">
